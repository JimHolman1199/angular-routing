...
/* harmony import */ var _contact_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contact.component */ "xQwi");
/* harmony import */ var _contact_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contact-routing.module */ "HX9d");
...
const routes = [
    {
        path: '', component: _contact_component__WEBPACK_IMPORTED_MODULE_2__["ContactComponent"], children: [
            {
                path: '',
                loadChildren: () => __webpack_require__.e(/*! import() | mailing-mailing-module */ "mailing-mailing-module").then(__webpack_require__.bind(null, /*! ./mailing/mailing.module */ "DH/L"))
            ...
            {
                path: 'map',
                loadChildren: () => __webpack_require__.e(/*! import() | map-map-module */ "map-map-module").then(__webpack_require__.bind(null, /*! ./map/map.module */ "arqN"))
                    .then(m => m.MapModule)
            },
            {
                path: '**',
